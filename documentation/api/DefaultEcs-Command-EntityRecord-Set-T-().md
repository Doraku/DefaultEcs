...
Sets the value of the component of type [T](#DefaultEcs-Command-EntityRecord-Set-T-()-T 'DefaultEcs.Command.EntityRecord.Set&lt;T&gt;().T') to its default value on the corresponding [Entity](./DefaultEcs-Entity.md 'DefaultEcs.Entity').  
...
```
#### Type parameters
<a name='DefaultEcs-Command-EntityRecord-Set-T-()-T'></a>
`T`  
