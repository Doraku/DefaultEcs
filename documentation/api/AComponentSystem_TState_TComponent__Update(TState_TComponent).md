...
```
#### Parameters
<a name='DefaultEcs_System_AComponentSystem_TState_TComponent__Update(TState_TComponent)_state'></a>
...
<a name='DefaultEcs_System_AComponentSystem_TState_TComponent__Update(TState_TComponent)_component'></a>
`component` [TComponent](AComponentSystem_TState_TComponent_.md#DefaultEcs_System_AComponentSystem_TState_TComponent__TComponent 'DefaultEcs.System.AComponentSystem&lt;TState,TComponent&gt;.TComponent')  
