...
## #ctor(DefaultEcs.World, DefaultEcs.IEntitySetObserver) `constructor`
...
<a name='DefaultEcs-System-AEntitySystem-T---ctor(DefaultEcs-World-_DefaultEcs-IEntitySetObserver)-world'></a>
`world`
...
<a name='DefaultEcs-System-AEntitySystem-T---ctor(DefaultEcs-World-_DefaultEcs-IEntitySetObserver)-observer'></a>
`observer`
...
[world](#DefaultEcs-System-AEntitySystem-T---ctor(DefaultEcs-World-_DefaultEcs-IEntitySetObserver)-world 'DefaultEcs.System.AEntitySystem&lt;T&gt;.#ctor(DefaultEcs.World, DefaultEcs.IEntitySetObserver).world') is null.
