...
## EntityQueryBuilderExtension.WhenAdded(EntityQueryBuilder, Type[]) Method
...
```
#### Parameters
<a name='DefaultEcs_EntityQueryBuilderExtension_WhenAdded(DefaultEcs_EntityQueryBuilder_System_Type__)_builder'></a>
...
<a name='DefaultEcs_EntityQueryBuilderExtension_WhenAdded(DefaultEcs_EntityQueryBuilder_System_Type__)_componentTypes'></a>
