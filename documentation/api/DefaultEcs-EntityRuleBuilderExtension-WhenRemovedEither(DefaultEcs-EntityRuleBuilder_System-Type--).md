...
## EntityRuleBuilderExtension.WhenRemovedEither(DefaultEcs.EntityRuleBuilder, System.Type[]) Method
Makes a rule to observe [Entity](./DefaultEcs-Entity.md 'DefaultEcs.Entity') when one component of the given types is removed.  
```csharp
public static DefaultEcs.EntityRuleBuilder WhenRemovedEither(this DefaultEcs.EntityRuleBuilder builder, params System.Type[] componentTypes);
```
#### Parameters
<a name='DefaultEcs-EntityRuleBuilderExtension-WhenRemovedEither(DefaultEcs-EntityRuleBuilder_System-Type--)-builder'></a>
...
<a name='DefaultEcs-EntityRuleBuilderExtension-WhenRemovedEither(DefaultEcs-EntityRuleBuilder_System-Type--)-componentTypes'></a>
