...
## TextSerializer.TextSerializer(Predicate&lt;Type&gt;) Constructor
...
```
#### Parameters
<a name='DefaultEcs_Serialization_TextSerializer_TextSerializer(System_Predicate_System_Type_)_componentFilter'></a>
