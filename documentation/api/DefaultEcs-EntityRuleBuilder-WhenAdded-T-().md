...
## EntityRuleBuilder.WhenAdded&lt;T&gt;() Method
Makes a rule to observe [Entity](./DefaultEcs-Entity.md 'DefaultEcs.Entity') when a component of type [T](#DefaultEcs-EntityRuleBuilder-WhenAdded-T-()-T 'DefaultEcs.EntityRuleBuilder.WhenAdded&lt;T&gt;().T') is added.  
```csharp
public DefaultEcs.EntityRuleBuilder WhenAdded<T>();
```
#### Type parameters
<a name='DefaultEcs-EntityRuleBuilder-WhenAdded-T-()-T'></a>
`T`  
