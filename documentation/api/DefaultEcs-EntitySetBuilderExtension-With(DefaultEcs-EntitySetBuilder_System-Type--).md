...
```
#### Parameters
<a name='DefaultEcs-EntitySetBuilderExtension-With(DefaultEcs-EntitySetBuilder_System-Type--)-builder'></a>
...
<a name='DefaultEcs-EntitySetBuilderExtension-With(DefaultEcs-EntitySetBuilder_System-Type--)-componentTypes'></a>
