namespace DefaultEcs
{
    ...
    public static class EntitySetBuilderExtension
    {
        ...
        /// <param name="builder">The <see cref="EntitySetBuilder"/> on which to create the rule.</param>
        /// <returns>The given <see cref="EntitySetBuilder"/>.</returns>
        public static EntitySetBuilder WithEither<T1, T2, T3, T4>(this EntitySetBuilder builder) => builder.WithEither(typeof(T1), typeof(T2), typeof(T3), typeof(T4));
        ...
        /// <param name="builder">The <see cref="EntitySetBuilder"/> on which to create the rule.</param>
        /// <returns>The given <see cref="EntitySetBuilder"/>.</returns>
        public static EntitySetBuilder WithEither<T1, T2, T3, T4, T5>(this EntitySetBuilder builder) => builder.WithEither(typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5));
    }
}
