...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DefaultEcsAnalyzerCodeFixProvider)), Shared]
    public class DefaultEcsAnalyzerCodeFixProvider : CodeFixProvider
    {
        private const string title = "Make uppercase";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(DefaultEcsAnalyzerAnalyzer.DiagnosticId); }
        }
